   ...
   <main class="container pt-5">
    ...
    <div class="row">
      <?php
        ...
        echo cardInformation('../../../app/views/products/products.php','Nuevos Productos para arreglar','Herramientas innovadoras para proyectos modernos.','../../../app/views/products/products.php','','../../../public/img/tools-construction-1.png','Comprar ahora');
        echo cardInformation('../../../app/views/products/products.php','Contamos con varios Productos','Haz click para explorar nuestros productos.','../../../app/views/products/products.php','','../../../public/img/tools-construction-2.png','Comprar ahora');
      ?>
    </div>
    <div class="p-5 row pt-3 pb-1 mt-3 shadow rounded align-items-center justify-content-between">
      <div class="col-md">
      <h5 class="">
            <img src="../../../public/icons/engineering.svg" alt="payment" style="width:35px;">
