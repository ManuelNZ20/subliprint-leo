...
<main class="container mb-3">
  <div class="row pt-5">
    <h1 class="col-md-12 text-center pt-4 pb-3 text-truncate" style="background-color:rgba(1, 141, 821, .5); color:white;"><i class="bi bi-cart4"></i> Carrito de compras</h1>
  </div>
